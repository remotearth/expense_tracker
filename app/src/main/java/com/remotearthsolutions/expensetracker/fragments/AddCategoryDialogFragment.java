...
//                categoryModel.setCategoryId(getNameByEditText);
...
//                    @Override
//                    public void run() {
//                        List<CategoryModel> categories = DatabaseClient.getInstance(getContext()).getAppDatabase().categoryDao().getAllCategories();
