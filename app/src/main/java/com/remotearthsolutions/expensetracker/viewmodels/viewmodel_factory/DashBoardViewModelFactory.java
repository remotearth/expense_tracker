...
public class DashBoardViewModelFactory implements ViewModelProvider.Factory {
    ...
    public DashBoardViewModelFactory(DashboardContract.View view, CategoryExpenseDao categoryExpenseDao, ExpenseDao expenseDao, CategoryDao categoryDao, AccountDao accountDao, FileProcessingService fileProcessingService) {
        this.view = view;
    ...
    public <T extends ViewModel> T create(@NonNull Class<T> modelClass) {
        return (T) new DashboardViewModel(view, categoryExpenseDao, expenseDao, categoryDao, accountDao, fileProcessingService);
    }
}
