...
package com.remotearthsolutions.expensetracker.utils.billing
        ...
        billingClient.startConnection(object : BillingClientStateListener {
            override fun onBillingSetupFinished(billingResult: BillingResult) {
                if (billingResult.responseCode == BillingClient.BillingResponseCode.OK) {
                    ...
                    queryPurchases()
                    queryProductDetails(Configs.getAdFreeProductId())
//                    billingConnectionState.postValue(true)
    ...
    fun queryProductDetails(product: String) {
        val params = QueryProductDetailsParams.newBuilder()
        val productList = mutableListOf(QueryProductDetailsParams.Product.newBuilder()
